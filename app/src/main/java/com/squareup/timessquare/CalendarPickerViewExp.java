...
/**
 * Android component to allow picking a date from a calendar view (a guestList of months).  Must be
 ...
 */
public class CalendarPickerViewExp extends ListView {
    ...
    private final CalendarPickerViewExp.MonthAdapter adapter;
    ...
    Date start;
    Date end;
    static String checkinout = null;
    static String samemonth = null;
    ...
    public CalendarPickerViewExp(Context context, AttributeSet attrs) {
        super(context, attrs);
        // ***Experience Start***
    ...
    public FluentInitializer init(Date minDate, Date maxDate, TimeZone timeZone, Locale locale) {
        ...
        // Now iterate between minCal and maxCal and build up our guestList of months to show.
    ...
    public class CellClickedListener implements MonthView.Listener {
        ...
        public void handleClick(MonthCellDescriptor cell) {
            ...
            if (!betweenDates(clickedDate, minCal, maxCal) || !isDateSelectable(clickedDate)) {
                ...
                if (checkhighlight) {
                    if (invalidDateListener != null) {
                        System.out.println("Blocked dates two ");
                        // snackBar();
     ...
     * un-selected.  In {@link SelectionMode#MULTIPLE}, the new date will be added to the guestList of
     * selected dates.
     * <p>
    ...
    public void startdate(String stdate) {
        System.out.println("Printcheck " + stdate);
        ...
        //   }
        String startdate1 = getFormatedDate2(stdate);
    ...
    public void enddate(String endate) {
        ...
        String searchenddate = getFormatedDateSearch(endate);
        //if(highlightedCals==null) {
    ...
    public static String getFormatedDate2(String strDate) {
        ...
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
            if (!getPreferedlanguageCode.equalsIgnoreCase("en")){
                ...
                writeFormat = new SimpleDateFormat("MMM dd, yyy", new Locale(getPreferedlanguageCode));
                ...
                writeFormat = new SimpleDateFormat("MMM dd, yyy", Locale.getDefault());
            }
        }else{
            if (!getPreferedlanguageCode.equalsIgnoreCase("en")){
                readFormat = new SimpleDateFormat("EEE MMM dd hh:mm:ss zzz yyy",new Locale(getPreferedlanguageCode));
                ...
                writeFormat = new SimpleDateFormat("MMM dd, yyy", Locale.ENGLISH);
                spdate=strDate;
            }
        }
        Date date = null;
