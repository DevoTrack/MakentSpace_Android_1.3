...
import com.makent.trioangle.dependencies.interceptors.AuthTokenInterceptor;
import com.makent.trioangle.dependencies.interceptors.NetworkInterceptor;
...
public class NetworkModule {
    ...
    public OkHttpClient.Builder providesOkHttpClient(Context context, HttpLoggingInterceptor httpLoggingInterceptor) {
        ...
        client.addInterceptor(new AuthTokenInterceptor(context));
