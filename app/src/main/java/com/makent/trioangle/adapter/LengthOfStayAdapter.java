...
public class LengthOfStayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public LengthOfStayAdapter(Context context, ArrayList<RoomLengthOfStay> Items) {
	...
	static class MovieHolder extends RecyclerView.ViewHolder{
		...
		void bindData(final RoomLengthOfStay movieModel, int position){
			...
			if(movieModel.getPeriod().equals("7")){
				period.setText(context.getResources().getString(R.string.weekly));
			}else if(movieModel.getPeriod().equals("28")){
				period.setText(context.getResources().getString(R.string.monthly));
			}else {
				if(movieModel.getPeriod().equals("1"))
					period.setText(movieModel.getPeriod()+" "+context.getResources().getString(R.string.night));
				else
					period.setText(movieModel.getPeriod()+" "+context.getResources().getString(R.string.nightss));
			}
