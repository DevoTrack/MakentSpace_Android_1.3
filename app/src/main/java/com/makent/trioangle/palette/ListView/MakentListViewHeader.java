...
public class MakentListViewHeader extends LinearLayout {
	...
	public MakentListViewHeader(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public MakentListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
