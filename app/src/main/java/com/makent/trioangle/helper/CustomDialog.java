...
public class CustomDialog extends BaseDialogFragment {
    ...
    public void showListPopup(Context context, List<String> options, View anchorView, popUpItemsClick listener) {
        ...
        listPopupWindow.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(context, R.color.title_text_color)));
    ...
    public void initViews(View v) {
        ...
        this.tvAllow = v.findViewById(R.id.tv_allow);
        this.tvDeny = v.findViewById(R.id.tv_deny);
        this.alertDialogLayout = v.findViewById(R.id.rlt_alert_dialog_layout);
        this.prgresslayout = v.findViewById(R.id.llt_progress_dialog);
        ...
        if (isProgressDialog) {
            ...
            if (index >= 0) {
                this.tvAllow.setTextColor(ContextCompat.getColor(mActivity, R.color.background));
            }
        }
