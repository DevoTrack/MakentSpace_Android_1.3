...
public final class ImageRotator {
    ...
    /**
     * Get rotation degrees of the selected ivPhoto. E.g.: 0º, 90º, 180º, 240º.
     *
     * @param context    context.
     * @param imageUri   URI of ivPhoto which will be analyzed.
     * @param fromCamera true if the ivPhoto was taken from camera,
