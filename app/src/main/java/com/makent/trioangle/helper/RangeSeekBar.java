...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#00A699");
    public static final int Default_Color = Color.parseColor("#DBDBDB");
    /**
    ...
    public static final int HEIGHT_IN_DP = 20;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.range_cir;
        int thumbPressed = R.drawable.range_cir;
        int thumbDisabled = R.drawable.range_cir;
       // int thumbDisabled = R.drawable.seek_thumb_disabled;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                mDefaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, Default_Color);
...
//        }
//        if(getResources().getString(R.string.layout_direction).equals("1")){
//            this.absoluteMinValue = maxValue;
//            this.absoluteMaxValue = minValue;
//           // setValuePrimAndNumberType();
//        }else{
//            this.absoluteMinValue = minValue;
//            this.absoluteMaxValue = maxValue;
...
//        }
    ...
    public void setSelectedMinValue(T value) {
        ...
        if (0 == (absoluteMaxValuePrim - absoluteMinValuePrim)) {
            ...
            System.out.println("setSelectedMinValue"+value);
    ...
    public void setSelectedMaxValue(T value) {
        ...
        if (0 == (absoluteMaxValuePrim - absoluteMinValuePrim)) {
            ...
            System.out.println("setSelectedMaxValue"+value);
...
//        }
    ...
    /**
     * Draws the "normal" resp. "pressed" thumb ivPhoto on specified x-coordinate.
     *
     * @param screenCoord The x-coordinate in screen space where to draw the ivPhoto.
    ...
    private double valueToNormalized(T value) {
        ...
        System.out.println("valueToNormalized"+(value.doubleValue() - absoluteMinValuePrim) / (absoluteMaxValuePrim - absoluteMinValuePrim));
