package com.makent.trioangle.placesearch;
        ...
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    // The API returned at least one resultTemp, update the data.
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            if (autocompletePredictions.getCount()<1) {
                // Toast.makeText(mContext, "Error contacting API: " + status.toString(),Toast.LENGTH_SHORT).show();
                Log.e("", "Error getting autocomplete getCount 0: " + status.toString());
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        ...
        for(int j=1;j<address.length;j++){
            try {
                ...
                System.out.println("J= "+j+"Sub address"+subaddress);
        ...
        /*if(localSharedPreferences.getSharedPreferencesInt(Constants.isHost)==1) {
            mPredictionHolder.mPrediction.setTextColor(this.mContext.getResources().getColor(R.color.text_shadow));
            mPredictionHolder.mPredictionSub.setTextColor(this.mContext.getResources().getColor(R.color.text_shadow));
            mPredictionHolder.mRow.setBackgroundColor(this.mContext.getResources().getColor(R.color.title_text_color));
        }*/
